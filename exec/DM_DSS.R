...
option_list <- list(
  ...
  optparse::make_option(c("-pc", "--pval_cutoff"), type = "double", default = 0.05,
  ...
  optparse::make_option(c("-rc", "--ratio_cutoff"), type = "double", default = 2,
                        help = "Choose the cutoff value [from 0 to inf] for the ratio areaStat/nSites used for DMR detection [default = %default]"),
  optparse::make_option(c("-x", "--context"), type = "character", default = "CG",
                        help = "name of the methylation context [default = %default]"),
  optparse::make_option(c("fp", "--filepPatten"), type = "character", default = NULL,
                        help = "suffix of the report.txt.gz file [default = %default]"),
  optparse::make_option(c("r", "--resPath"), type = "character", default = NULL,
                        help = "path to local resources [default = %default]"),
  optparse::make_option(c("rp", "--reportPath"), type = "character", default = NULL,
                        help = "path to the report.txt.gz file [default = %default]"),
  optparse::make_option(c("w", "--wd"), type = "character", default = ".",
                        help = "path to the directory where DMRichR results will be stored [default = %default]"),
  optparse::make_option(c("f1", "--factor1"), type = "character", default = NULL,
                        help = "the first factor to be tested [default = %default]"),
  optparse::make_option(c("f2", "--factor2"), type = "character", default = NULL,
